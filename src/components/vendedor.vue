        ...
        <q-dialog v-model="modal" no-backdrop-dismiss>
          <q-card class="conten_modal">
            <q-card-section class="arri">
              <div class="text-h6">DATOS DE VENDEDORES
              ...
              <div class="imagen_formulario">
                <div class="infoDatos">
                  ...
                  <div class="conten_input">
                    ...
                    <div class="containerInput">
                      <input placeholder="Apellido" type="text" id="APELLIDO" v-model="apellido" autocomplete="on" />
                    </div>
                  ...
                  <div class="conten_input">
                    ...
                    <div class="containerInput">
                      <input placeholder="Usuario" type="text" id="USUARIO" v-model="usuario" autocomplete="on" />
                    </div>
                  ...
                  <div class="conten_input">
                    ...
                    <div class="containerInput">
                      <input placeholder="Password" type="text" id="CONTRASENA" v-model="contrasena" autocomplete="on" />
                    </div>
