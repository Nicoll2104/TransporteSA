...
const columns = [
  ...
  { name: "ruta", required: true, label: "Hora_Salida", align: "left", field: (row) => row.ruta.horarios, sortable: true },
  ...
  { name: "numero", required: true, label: "Numero de bus", align: "left", field: (row) => row.bus.numero, sortable: true },
